<h2><a href="https://www.geeksforgeeks.org/problems/distinct-sorted--124713/1?page=7&category=Java,number-theory&status=unsolved&sortBy=submissions">Distinct Sorted</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[],</strong> return all<strong> distinct </strong>elements of the array in sorted (non-decreasing) order</span><span style="font-size: 18px;">.</span></p>
